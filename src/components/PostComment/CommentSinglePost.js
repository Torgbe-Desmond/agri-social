...
import CommentSinglePostBody from "./CommentSinglePostBody";

const CommentSinglePost = forwardRef(({ post }, ref) => {
  ...
  return (
    <Box
      ...
      id={`comment-single-post-${post?.post_id}`}
      ref={ref}
    >
      <CommentPostHeader post={post} />
      <CommentSinglePostBody post={post} />
